...
> The default setting is ```--auto-detect-browser --key --email-api emailfake --proxy-file proxies.txt``` so that when you start the program you can immediately select **Start** and you will generate your ESET HOME key through the chrome browser
